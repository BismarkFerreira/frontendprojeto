...
import { Demo, Projeto } from '../../../../types/types';
...
const Crud = () => {
    ...
    //FAZ A COMUNICAÇÃO COM O BECKEND PARA TRAZER AS INFORMAÇÕES
    useEffect(() => {
    ...
    //SERÁ VERIFICADO DEPOIS POIS CONECTA COM O BACKEND TAMBÉM!
    const deleteUsuario = () => {
    ...
    // OBS: PROFESSOR COMENTOU QUE NÃO SERÁ UTILIZADO POIS O BACKEND É QUEM FARÁ ESSES PROCEDIMENTOS
    ...
    // OBS: PROFESSOR COMENTOU QUE NÃO SERÁ UTILIZADO!
